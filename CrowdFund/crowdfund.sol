...
contract CrowdFund {
    ...
    function launch(
        ...
        require(_endAt <= block.timestamp+ 90 days, "Max Duration was exceeded");
    ...
    function cancel(uint _id) external {
        ...
        require(msg.sender == campaign.creator,"Unauthorized");
    ...
    function pledge(uint _id, uint _amount) external {
       ...
       require(block.timestamp <= campaign.endAt, "Campaign is too old");
    ...
    function unpledge(uint _id, uint _amount) external {
        Campaign storage campaign = campaigns[_id];
        require(block.timestamp <= campaign.endAt, "This event has ended");
    ...
    function claim(uint _id) external {
        ...
        require(campaign.pledged >= campaign.goal, "not enough funders");
